<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDetail.aspx.cs" Inherits="add_product.ViewDetail" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Product Details - Timeless Watches</title>
...
<%--    <header>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="detail-card animate-on-scroll fade-in-up">
                <asp:Image ID="imgWatch" runat="server" CssClass="detail-img animate-on-scroll scale-in delay-1" />
                <h2 class="animate-on-scroll fade-in-left"><asp:Label ID="lblName" runat="server"></asp:Label></h2>
                <p class="animate-on-scroll fade-in-right delay-1"><b>Brand:</b> <asp:Label ID="lblBrand" runat="server"></asp:Label></p>
                <p class="animate-on-scroll fade-in-left delay-2"><b>Type:</b> <asp:Label ID="lblType" runat="server"></asp:Label></p>
                <p class="price animate-on-scroll fade-in-up delay-2">₹ <asp:Label ID="lblPrice" runat="server"></asp:Label></p>
                <p class="animate-on-scroll fade-in-right delay-3"><b>Available Qty:</b> <asp:Label ID="lblQty" runat="server"></asp:Label></p>
                <asp:Button ID="btnBack" runat="server" Text="⬅ Back to Shop" CssClass="btn-back animate-on-scroll fade-in-up delay-3" PostBackUrl="Shop.aspx" />
            </div>
        </div>
    </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Add interactive cursor effect for detail card
            ...
            if (detailCard) {
                detailCard.addEventListener('mousemove', (e) => {
                    ...
                    detailCard.style.transform = `perspective(1000px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) translateY(-10px)`;
                });
